...
注意B电脑访问A电脑子网时，B电脑不能有该网段,A电脑需要在防火墙上配置（这样B电脑才能访问到A电脑）。
...
# [非最佳]Free Download Manager(浏览器下载托管，可代替付费的IDM，挺不错的，但并不轻量无下载状态占用180M，轻量请用NDM #FDM)
