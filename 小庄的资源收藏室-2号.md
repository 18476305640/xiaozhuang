...
# QuickLook（文件预览，选择文件按空格即可预览，可通过安装插件支持更多类型）
https://github.com/QL-Win/QuickLook
----
## 安装插件：
https://github.com/QL-Win/QuickLook/wiki/Available-Plugins
如何安装？将插件`.qlplugin` 文件下载下来，选择插件文件按空格，点击右下方的安装再重启软件即可。

常见插件下载：
- Office类型支持 [下载](https://github.com/QL-Win/QuickLook.Plugin.OfficeViewer-Native)
- 思维导图xmind：[下载](https://github.com/zhangkaihua88/QuickLook.Plugin.XMindViewer-Thumbnail)
