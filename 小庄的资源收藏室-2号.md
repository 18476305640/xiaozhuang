...
https://www.memfree.me[[/search?q={keyword}]]
...
# [推荐]HostsFileEditor(轻量的编辑和管理 Windows 的 hosts 文件的工具)
https://github.com/scottlerch/HostsFileEditor
----
![](https://cdn.jsdelivr.net/gh/18476305640/typora@master/images/2024/08/10/1723259877875.png)
其它：
...
# [h'程序员'] Jenkins插件（搜索插件查看适合jenkins-plgins对应版本兼容）
https://plugins.jenkins.io[[/ui/search/?query={keyword}]]
----
[如何处理jenkins-plgins版本兼容](https://blog.csdn.net/qq_15092991/article/details/132079554)
