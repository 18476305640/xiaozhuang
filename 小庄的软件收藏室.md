...
[推荐]Notepad3(最佳替换window记事本的文本编辑器)：https://github.com/rizonesoft/Notepad3/releases
...
常用的fan墙客户端（常用的fan墙客户端）：1、[clash](https://github.com/Fndroid/clash_for_windows_pkg) <br /> 2、[clashN-可以自动刷新](https://github.com/2dust/clashN) <br />[更多>>](https://v2rayssr.com/vpn-client.html)
