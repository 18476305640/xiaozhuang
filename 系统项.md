# [系统项]使用说明（了解新功能）
  ...
  6、呼出搜索框直接回车，输入问题再回车即可体现AI简单问答功能。
...
headers.append("Authorization", `Bearer ${window.atob("c2stcHJvai12RDRONnR4bFpsVEZKOU54MjZvQVQzQmxia0ZKUGY2NWlZakNtUzdtYnNpZzlZSWY")}`);
