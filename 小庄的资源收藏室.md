...
-- script --
function ({open}) {
   open("https://pan.lanzoub.com/b0aikuwgh").simulator( ({ click, roll, dimension })=>{});
}

# OpenSearcher（文本文件搜索，多文件无需一一打开批量搜索，右击文件夹进行搜索里面文本文件内容）
...
# Gnomic（登录后免费使用各个AI，GPT4也免费使用，没有条数限制）
https://gnomic.cn/

# Coze(免费创建使用基于GPT4的机器人)
https://www.coze.com/
----
![image](https://github.com/18476305640/xiaozhuang/assets/63949859/f27bfb6a-75d6-4a3f-b1b0-37f0e825c726)
