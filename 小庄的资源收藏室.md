...
----
[脚本一](https://sleazyfork.org/zh-CN/scripts/462265-%E6%B5%B7%E8%A7%92%E7%A4%BE%E5%8C%BA%E8%84%9A%E6%9C%AC)
...
# Portainer(Docker UI操作页面，有常见的容器模板，就填一些该填的就可以了)
https://github.com/outlovecn/portainer-cn
----
具体部署：
1、`docker pull outlovecn/portainer-cn` 或者 `docker pull ghcr.io/outlovecn/portainer-cn:main`
2、`docker run -d -p 8000:8000 -p 9000:9000 --name=portainer --restart=always -v /var/run/docker.sock:/var/run/docker.sock -v portainer_data:/data outlovecn/portainer-cn:latest`
3、访问 http://<ip>:9000 
4、模板在这里
![](https://cdn.jsdelivr.net/gh/18476305640/typora@master/images/2023/12/10/1702203357672.png)
5、模板容器部署
![](https://cdn.jsdelivr.net/gh/18476305640/typora@master/images/2023/12/10/1702203433468.png)
