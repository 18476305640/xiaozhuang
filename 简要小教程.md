...
```
安装-配置：http://<ip>:8080/install.php , [去查看如何配置>>](https://cdn.jsdelivr.net/gh/18476305640/typora@master/images/2023/08/17/1692256644942.png)
后台地址：http://<ip>:8080/settings.php
解析页面地址：http://<ip>:8080/

经过上面的配置后，就可以进入解析页面解析百度网盘分享链接了！
解析后是要将下载请求发送到下载器的，你需要下载[Aria2](http://aria2.scrongyao.com/),然后再安装个[Aria2插件](https://chrome.google.com/webstore/detail/aria2-explorer/mpkodccbngfoacfalldjimigbofkhgjn)即可！就可以将下载请求发送到Aria2下载了，下载进度可以去Aria2插件视图。
